...
*/
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    _______,          KC_VOLU, KC_VOLD, KC_MUTE, _______, _______, _______, _______, _______, KC_MPRV,  KC_MNXT,  _______,
    _______, _______, _______,                            KC_MPLY,                   _______, _______, MO(FN2), _______
),
  /*
  * Layer FN2
  * ,-----------------------------------------------------------------------------------------.
 ...
 [FN2] = LAYOUT_60_ansi( /* FN2 */
    KC_GRV, KC_AP2_BT1, KC_AP2_BT2, KC_AP2_BT3, KC_AP2_BT4, _______, _______, _______, _______, KC_AP_RGB_MOD, KC_AP_RGB_TOG, KC_AP_RGB_VAD, KC_AP_RGB_VAI, _______,
    _______, MS_WHLU,    MS_UP,      MS_WHLD,    _______,    _______, _______, _______, _______, _______,       KC_PSCR,       KC_HOME,       KC_END,        _______,
    _______, MS_LEFT,    MS_DOWN,    MS_RGHT,    _______,    _______, _______, _______, _______, _______,       KC_PGUP,       KC_PGDN,       _______,
    _______,             MS_BTN1,    MS_BTN2,    _______,    _______, QK_BOOT, _______, _______, _______,       KC_INS,        KC_DEL,        _______,
